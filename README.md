...
Blockchain-Enabled Broadcast (BEB) Dimensions are open-source, self-hosted nodes for the [open multi-domain BEB protocol](https://github.com/bebverse/protocol).
