...
Universe is an implementation of a BEB (Blockchain-Enabled Broadcast) Dimension. Universes are open-source, self-hosted nodes for [BEB, an open messaging protocol](https://github.com/bebverse/protocol).
